...
from config import image_folder,ouput_all_image,ouput_all_point
...
os.makedirs(ouput_all_image, exist_ok=True)

#delete all file in folder
for filename in os.listdir(ouput_all_image):
    file_path = os.path.join(ouput_all_image, filename)
    ...
    if filename.endswith(".jpg") or filename.endswith(".png"):  # Adjust the file extensions as needed
        ...
        with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
            ...
            if results.pose_landmarks:
                ...
                output_path = os.path.join(ouput_all_image, f"set_{number:02}{file_extension}")
...
with open(ouput_all_point, "w") as f:
